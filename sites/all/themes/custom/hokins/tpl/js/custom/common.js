...
/* body */
    ...
    //$('#u881_1').registerPositionScrollEffect([{"in":[-Infinity,6826],"speed":[0,3]},{"in":[6826,Infinity],"speed":[0,1]}]);
    //$('#u881_2').registerPositionScrollEffect([{"in":[-Infinity,6846],"speed":[0,3]},{"in":[6846,Infinity],"speed":[0,1]}]);
    //$('#u881_3').registerPositionScrollEffect([{"in":[-Infinity,6866],"speed":[0,3]},{"in":[6866,Infinity],"speed":[0,1]}]);
    //$('#u881_4').registerPositionScrollEffect([{"in":[-Infinity,6886],"speed":[0,3]},{"in":[6886,Infinity],"speed":[0,1]}]);
    //$('#u881_5').registerPositionScrollEffect([{"in":[-Infinity,6906],"speed":[0,3]},{"in":[6906,Infinity],"speed":[0,1]}]);
    //$('#u881_6').registerPositionScrollEffect([{"in":[-Infinity,6926],"speed":[0,3]},{"in":[6926,Infinity],"speed":[0,1]}]);
    //$('#u881_7').registerPositionScrollEffect([{"in":[-Infinity,6946],"speed":[0,3]},{"in":[6946,Infinity],"speed":[0,1]}]);
